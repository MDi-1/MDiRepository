...
public class CruddAppTestSuite {
    private static final String BASE_URL = "https://mdi-1.github.io/";
    ...
    private boolean checkTaskExistsInTrello(String taskName) throws InterruptedException {
        ...
        driverTrello.findElement(By.id("user")).sendKeys(trelloMail);  // [3]
        driverTrello.findElement(By.id("password")).sendKeys(trelloPass);	// [4]
        WebElement el = driverTrello.findElement(By.id("login"));
        el.submit();									                            // [5]
        Thread.sleep(4000);								                            // [6]
        driverTrello.findElement(By.id("password")).sendKeys(trelloPass);    // [7]
